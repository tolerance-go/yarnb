...
const list = [
   ...
   },
   {
      ...
      zhDesc:
         '我记得第一次坐地铁的时候，那个激动啊，哈哈哈嗝；这家公司刚进去的时候正在高速发展当中，认识了很多牛人，自身的前端技术也飞速成长，从零搭建了考拉 KOL 系统，当运营来咨询我问题的时候，我才发现原来，我开发的系统真的有人在用啊，这次比第一次坐地铁更激动，哈哈哈嗝',
      desc: 'I remember when I took the subway for the first time, I was so excited, hahahaha; this company was developing at a high speed when I first entered, and I met a lot of great people, and my own front-end technology also grew rapidly. I built a koala KOL from scratch. System, when the operator came to ask me questions, I realized that the system I developed was actually used by people. This time I was more excited than the first time I took the subway, hahaha hiccup',
   },
   {
